...
CELERY_ROUTES = (
    [
        (
            ...
            {"queue": "xdc_tokens", "delivery_mode": "transient"},
        ),
        (
            "safe_transaction_service.history.tasks.send_webhook_task",
            {"queue": "xdc_webhooks", "delivery_mode": "transient"},
        ),
        (
        ...
        (
            ...
            {"queue": "xdc_indexing", "delivery_mode": "transient"},
        ),
        (
            "safe_transaction_service.contracts.tasks.*",
            {"queue": "xdc_contracts", "delivery_mode": "transient"},
        ),
        (
            "safe_transaction_service.notifications.tasks.*",
            {"queue": "xdc_notifications", "delivery_mode": "transient"},
        ),
        (
